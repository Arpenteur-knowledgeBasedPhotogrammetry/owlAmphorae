...
import org.arpenteur.protege.plugin.set.view.AddProperty;
import org.arpenteur.protege.plugin.set.view.DeleteProperty;
...
public class IndividualsJTree extends JTree implements ActionListener {
	...
	public IndividualsJTree (TreeModel mutableTreeNode) {
