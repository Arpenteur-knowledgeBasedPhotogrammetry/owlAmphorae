...
public class AddProperty extends JPanel{
	...
	public void addObjectProperty(OWLOntology ontology, OWLOntologyManager manager, String objectPropertyName, String individualValue) {
		OWLDataFactory factory = manager.getOWLDataFactory();
		...
		for (OWLClass c : ontology.getClassesInSignature()) {
			...
			OWLNamedIndividual originIndName = factory.getOWLNamedIndividual(IRI.create(prefix + IndividualsPanel.individualName));
